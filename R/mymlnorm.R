...
#'
#' The function estimates the maximum likelihood for the mean and standard deviation of a normal distribution based on a given vector
#'
#'
#' @param x a vector representing the sample data
#' @param mu vector value of the mean
#' @param sig A vector value of the standard deviation
...
#' @importFrom stats sd
#'
#' @return a graphic and x/y coords to a point
#' @export
#'
